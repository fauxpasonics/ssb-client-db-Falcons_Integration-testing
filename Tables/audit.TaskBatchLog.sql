...
[CreatedOn] [datetime] NULL CONSTRAINT [DF__TaskBatch__Creat__32E0915F] DEFAULT ([etl].[ConvertToLocalTime](CONVERT([datetime2](0),getdate(),(0)))),
[CreatedBy] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__TaskBatch__Creat__33D4B598] DEFAULT (suser_sname())
)
GO
ALTER TABLE [audit].[TaskBatchLog] ADD CONSTRAINT [PK__TaskBatc__3214EC27CFF60F7C] PRIMARY KEY CLUSTERED  ([ID])
GO
